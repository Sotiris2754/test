...
<a-entity id="frame" position=" -0.2 1 -5" visible="false">
	...
	<a-plane color="#ECDFCC" id="panel" position="0 -.3 0" scale ="0.7 0.7 0.7" width="1.5" height="0.75">
...
<a-entity rotation="0 180 0" position="0.15 0 -3">
